...
function populateGryffindorTable() {
    ...
    tableContent += '<td><a href="#" class="linkdeleteGryffindor" rel="' + this._id + '">delete</a></td>';
    tableContent += '</tr>';
    });
    tableContent+='</table>'
...
function populateHufflepuffTable() {
  ...
  $.getJSON( '/client/rest/Hufflepuff', function( data ) {
    ...
    tableContent += '<td><a href="#" class="linkdeleteHufflepuff" rel="' + this._id + '">delete</a></td>';
    tableContent += '</tr>';
    });
    tableContent+='</table>';
...
function populateRavenclawTable() {
  ...
  $.getJSON( '/client/rest/Ravenclaw', function( data ) {
    ...
    tableContent += '<td><a href="#" class="linkdeleteRavenclaw" rel="' + this._id + '">delete</a></td>';
    tableContent += '</tr>';
    });
    tableContent+='</table>';
...
function populateSlytherinTable() {
    ...
    tableContent += '<td><a href="#" class="linkdeleteSlytherin" rel="' + this._id + '">delete</a></td>';
    tableContent += '</tr>';
    });
    tableContent+='</table>';
...
function addUser(event) {
   ...
   $.ajax({
        type: 'POST',
        data: newUser,
        url: serverURL+'/users/Gryffindor',
        header: {
   ...
   $.ajax({
        type: 'POST',
        data: newUser,
        url: serverURL+'/users/Hufflepuff',
...
function deleteGryffindor(event) {
    ...
    event.preventDefault();
    var confirmation = confirm('Remove the student from Hogwards?');
    if (confirmation === true) {
      $.ajax({
        type: 'DELETE',
        url: serverURL+'/users/Gryffindor/' + $(this).attr('rel'),
        header: {
          'Access-Control-Allow-Origin':'*'
        },
      }).done(function( response ) {
...
function deleteHufflepuff(event) {
    ...
    if (confirmation === true) {
      $.ajax({
        type: 'DELETE',
        url: serverURL+'/users/Hufflepuff/' + $(this).attr('rel'),
        header: {
          'Access-Control-Allow-Origin':'*'
        },
      }).done(function( response ) {
...
function deleteRavenclaw(event) {
    ...
    if (confirmation === true) {
      $.ajax({
        type: 'DELETE',
        url: serverURL+'/users/Ravenclaw/' + $(this).attr('rel'),
        header: {
          'Access-Control-Allow-Origin':'*'
        },
      }).done(function( response ) {
...
function deleteSlytherin(event) {
    ...
    if (confirmation === true) {
      $.ajax({
        type: 'DELETE',
        url: serverURL+'/users/Slytherin/' + $(this).attr('rel'),
        header: {
          'Access-Control-Allow-Origin':'*'
        },
      }).done(function( response ) {
